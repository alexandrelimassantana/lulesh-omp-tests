...
binlpt:	CXXFLAGS+=-DOMP_BINLPT

static:	CXXFLAGS+=-DOMP_STATIC

keep:	CXXFLAGS+=-DMOGSLIB_KEEP

binlpt static keep mogslib: $(OBJECTS2.0)
	@echo "Linking"
	$(CXX) $(OBJECTS2.0) $(LDFLAGS) -lm -o $(LULESH_EXEC)-$@
